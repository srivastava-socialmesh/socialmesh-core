import { Home, User, MessageCircle, Users, Compass } from 'lucide-react';

interface LeftSidebarProps {
  activeTab: 'feed' | 'profile' | 'messages' | 'friends' | 'discover';
  setActiveTab: (tab: 'feed' | 'profile' | 'messages' | 'friends' | 'discover') => void;
  connected: boolean;
  targetId: string;
}
